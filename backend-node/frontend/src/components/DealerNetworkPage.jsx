...
export const DealerNetworkPage = () => {
  ...
  const handleApplySubmit = (e) => {
    ...
    setTimeout(() => {
      const existingApps = JSON.parse(localStorage.getItem('fazo_dealer_applications')) || [];
      const newApp = {
        id: 'app_' + Date.now(),
        ...applyForm,
      ...
      localStorage.setItem('fazo_dealer_applications', JSON.stringify(existingApps));
      ...
      <div className="max-w-[1200px] mx-auto relative z-10 flex flex-col gap-8 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
          ...
          <div className="md:col-span-7 lg:col-span-8 rounded-[28px] p-8 sm:p-10 border border-[#E2EAEB]/80 relative overflow-hidden flex flex-col justify-between min-h-[260px] bg-[#FAFBFD]/95 shadow-[0_15px_45px_rgba(11,37,48,0.03)]">
            ...
            <div>
              ...
              <h1 className="font-jakarta font-extrabold text-3xl sm:text-4xl lg:text-[40px] leading-[1.15] text-fazo-navy mb-4 tracking-tight">
                Find a FAZO Dealer <br /> Near You
              </h1>
            </div>

            <p className="font-sans text-xs sm:text-sm text-fazo-gray leading-relaxed max-w-[540px] mt-2">
              Locate authorized FAZO dealers and distribution partners across India and international markets for product inquiries, support, and business opportunities.
            </p>
          </div>
          ...
          <div className="md:col-span-5 lg:col-span-4 rounded-[28px] p-6 sm:p-8 border border-[#E2EAEB]/80 relative overflow-hidden flex flex-col justify-between bg-[#FAFBFD]/95 min-h-[260px] shadow-[0_15px_45px_rgba(11,37,48,0.03)]">
            ...
            <div className="mb-2">
              <span className="text-[10px] font-bold text-fazo-gray uppercase tracking-wider block">FAZO IMPACT</span>
              <h3 className="font-jakarta font-extrabold text-sm text-fazo-navy mt-0.5">Reliable Presence</h3>
            </div>
            ...
            <div className="flex flex-col gap-6 my-auto pt-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-lg font-extrabold text-fazo-navy leading-none">500+</div>
                  <div className="text-[10px] text-fazo-gray font-bold uppercase mt-0.5 tracking-wider">Installations</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-lg font-extrabold text-fazo-navy leading-none">1500+</div>
                  <div className="text-[10px] text-fazo-gray font-bold uppercase mt-0.5 tracking-wider">Customers</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-lg font-extrabold text-fazo-navy leading-none">11+</div>
                  <div className="text-[10px] text-fazo-gray font-bold uppercase mt-0.5 tracking-wider">Years Experience</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
          ...
          <div className="md:col-span-6 lg:col-span-5 rounded-[28px] p-6 border border-[#E2EAEB]/80 bg-[#FAFBFD]/95 flex flex-col gap-4 relative overflow-hidden shadow-[0_15px_45px_rgba(11,37,48,0.03)]">
            ...
            <div>
              <span className="text-[10px] font-bold text-fazo-navy uppercase tracking-wider pl-1 flex items-center gap-1.5">
                <Globe className="w-3.5 h-3.5 text-[#0A7C86]" /> Select Country
              </span>
              <p className="text-[10px] text-fazo-gray pl-1 mt-0.5">Click a country to load regions</p>
            </div>
                ...
                <button
                  ...
                  className={`py-2.5 px-1.5 rounded-xl text-[11px] font-bold transition-all duration-300 border flex flex-col items-center justify-center text-center leading-tight shadow-sm hover:scale-[1.02] cursor-pointer ${
                    country === c
                      ...
                      : 'bg-white/40 border-white/50 text-fazo-navy hover:bg-white/70 hover:border-[#0A7C86]/30'
                  }`}
                >
                  {c}
                </button>
          ...
          <div className="md:col-span-6 lg:col-span-4 rounded-[28px] p-6 border border-[#E2EAEB]/80 bg-[#FAFBFD]/95 flex flex-col gap-4 min-h-[196px] relative overflow-hidden shadow-[0_15px_45px_rgba(11,37,48,0.03)]">
            ...
            <div>
              ...
              <p className="text-[10px] text-fazo-gray pl-1 mt-0.5">Filter by localized state</p>
            </div>
              ...
              {country === 'Others' ? (
                <div className="w-full">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-white bg-white/50 focus:outline-none focus:border-[#0A7C86] text-xs font-semibold text-fazo-navy shadow-inner transition-all"
                    value={stateRegion}
                  ...
                  <button
                    ...
                    className={`py-1.5 px-3 rounded-lg text-[11px] font-bold transition-all border cursor-pointer ${
                      stateRegion === ''
                        ...
                        : 'bg-white/30 border-white/50 text-fazo-navy hover:bg-white/60'
                    }`}
                  >
                    All Regions
                  </button>
          ...
          <div className="md:col-span-12 lg:col-span-3 rounded-[28px] p-6 border border-[#E2EAEB]/80 bg-[#FAFBFD]/95 flex flex-col justify-between min-h-[196px] relative overflow-hidden shadow-[0_15px_45px_rgba(11,37,48,0.03)]">
            ...
            <div>
              ...
              <p className="text-[10px] text-fazo-gray pl-1 mt-0.5">Filter cards dynamically</p>
            </div>
            ...
            <div className="my-4 relative w-full">
              <input
                ...
                className="w-full pl-9 pr-4 py-3.5 rounded-xl border border-white/60 bg-white/50 focus:outline-none focus:border-[#0A7C86] focus:ring-1 focus:ring-[#0A7C86] text-xs font-semibold text-fazo-navy shadow-inner transition-all duration-300 focus:bg-white focus:shadow-[0_0_15px_rgba(10,124,134,0.15)]"
              />
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-fazo-navy/40 pointer-events-none" />
            </div>

            <div className="text-[10px] text-fazo-gray/70 pl-1">
        ...
        <div className="mt-8">
          {/* Header Info */}
          <div className="max-w-4xl mx-auto mb-8 flex flex-col sm:flex-row sm:items-center justify-between border-b border-fazo-border/40 pb-4 gap-4">
            <div>
              <h2 className="font-jakarta font-extrabold text-lg text-fazo-navy tracking-tight flex items-center gap-2">
                <Building className="w-5 h-5 text-[#0A7C86]" /> Authorized Network Partners
              </h2>
              <p className="font-sans text-xs text-fazo-gray mt-1">
            ...
            <div className="self-start sm:self-auto glass-badge px-3 py-1 rounded-full text-xs font-bold text-fazo-navy flex items-center gap-1.5 shadow-sm border border-white">
          ...
          <div className="w-full">
            {filteredDealers.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full w-full">
                      <div>
                        ...
                        {/* Location */}
                        <div className="flex items-start gap-1.5 text-xs text-fazo-gray font-semibold mb-5">
                          <MapPin className="w-3.5 h-3.5 text-fazo-gray/70 shrink-0 mt-0.5" />
                          <span>{dealer.city}, {dealer.state}, {dealer.country}</span>
                        </div>

                        {/* Separator */}
                        <div className="border-t border-fazo-border/30 my-4" />

                        {/* Contact Info */}
                        <div className="flex flex-col gap-2.5">
                          <div className="text-left">
                            <span className="text-[10px] text-fazo-gray font-bold uppercase tracking-wider block">Contact Person</span>
                            <span className="font-sans text-xs font-bold text-fazo-navy flex items-center gap-1.5 mt-0.5">
                          ...
                          <div className="flex flex-col gap-1.5 mt-1">
                            <a 
                              ...
                              className="font-sans text-xs text-fazo-gray hover:text-[#0A7C86] transition-colors flex items-center gap-2 font-medium"
                            >
                              <Phone className="w-3.5 h-3.5 text-fazo-gray/70" /> {dealer.phone}
                            </a>
                            <a 
                              href={`mailto:${dealer.email}`} 
                              className="font-sans text-xs text-fazo-gray hover:text-[#0A7C86] transition-colors flex items-center gap-2 font-medium break-all"
                            >
                              <Mail className="w-3.5 h-3.5 text-fazo-gray/70" /> {dealer.email}
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Map Button */}
                      {dealer.mapsLink && (
                        <div className="mt-6 pt-4 border-t border-fazo-border/20">
                          <a
                            href={dealer.mapsLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full text-center py-2.5 bg-white/50 hover:bg-white border border-fazo-border/50 hover:border-[#0A7C86]/35 text-xs font-extrabold text-fazo-navy hover:text-[#0A7C86] rounded-xl flex items-center justify-center gap-1.5 transition-all duration-300 shadow-sm"
                          >
              ...
              >
                ...
                <h3 className="font-jakarta font-extrabold text-lg text-fazo-navy">No Dealers Found</h3>
                <p className="font-sans text-xs sm:text-sm text-fazo-gray leading-relaxed">
                  We currently do not have registered dealers in <span className="font-bold text-fazo-navy">{stateRegion || country}</span>. Please try another location or contact our team for assistance.
                </p>
                <button
        ...
        <div className="w-full max-w-4xl mx-auto mt-6">
          <div className="glass-card rounded-[24px] p-8 sm:p-10 border border-white/50 shadow-md relative overflow-hidden bg-gradient-to-r from-[#EAF2F4]/80 via-[#F4F9FA]/80 to-[#E6F3F5]/80 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="absolute top-0 right-0 w-44 h-44 bg-gradient-to-bl from-fazo-teal/10 to-transparent blur-3xl pointer-events-none" />
            
            <div className="flex flex-col items-start text-left max-w-xl">
              <span className="font-sans font-bold text-[10px] tracking-wider text-[#0A7C86] uppercase mb-2 block">
                Become a FAZO Dealer
              </span>
              <h3 className="font-jakarta font-extrabold text-xl sm:text-2xl text-fazo-navy tracking-tight mb-2">
                Interested in partnering with FAZO?
              </h3>
              <p className="font-sans text-xs sm:text-sm text-fazo-gray leading-relaxed">
        ...
        {isApplyModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <button
                onClick={() => setIsApplyModalOpen(false)}
                className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-fazo-light text-fazo-navy/60 hover:text-fazo-navy transition"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              {!formSubmitted ? (
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="font-jakarta font-extrabold text-xl text-fazo-navy tracking-tight">
                      Dealership Application
                    </h2>
                  </div>
                  
                  <p className="font-sans text-xs text-fazo-gray leading-relaxed mb-6">
                  ...
                  <form onSubmit={handleApplySubmit} className="flex flex-col gap-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="app-name" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Full Name *</label>
                        <input
                          id="app-name"
                          type="text"
                          required
                      ...
                      <div>
                        <label htmlFor="app-company" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Company Name *</label>
                        <input
                          id="app-company"
                          type="text"
                          required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="app-email" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Email Address *</label>
                        <input
                          id="app-email"
                          type="email"
                          required
                      ...
                      <div>
                        <label htmlFor="app-phone" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Phone Number *</label>
                        <input
                          id="app-phone"
                          type="tel"
                          required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="app-country" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Country *</label>
                        <select
                          id="app-country"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-fazo-border bg-white focus:outline-none focus:border-[#0A7C86] text-xs text-fazo-navy transition cursor-pointer font-semibold"
                      ...
                      <div>
                        <label htmlFor="app-type" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Partnership Type *</label>
                        <select
                          id="app-type"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-fazo-border bg-white focus:outline-none focus:border-[#0A7C86] text-xs text-fazo-navy transition cursor-pointer font-semibold"
                    ...
                    <div>
                      <label htmlFor="app-msg" className="block text-[10px] font-bold text-fazo-navy uppercase mb-1.5">Business Proposal / Message</label>
                      <textarea
                        id="app-msg"
                        rows="3"
                    ...
                    <div className="flex gap-3 border-t border-fazo-border/30 pt-4 mt-2">
                      <button
                        type="button"
                        onClick={() => setIsApplyModalOpen(false)}
                        className="flex-1 py-3 border border-fazo-border rounded-xl text-xs font-bold text-fazo-navy hover:bg-fazo-light transition"
                      >
                        Cancel
                      </button>
                      <button
                ...
                <div className="text-center py-6 flex flex-col items-center gap-4">
                  ...
                  <h3 className="font-jakarta font-extrabold text-xl text-fazo-navy">Application Received!</h3>
                  <p className="font-sans text-xs sm:text-sm text-fazo-gray leading-relaxed max-w-sm">
                    Thank you, <span className="font-bold text-fazo-navy">{applyForm.name}</span>. Your application for <span className="font-bold text-[#0A7C86]">{applyForm.companyName}</span> has been logged. Our partnership desk will reach out soon.
                  </p>
                  <button
                    onClick={() => { resetApplyForm(); setIsApplyModalOpen(false); }}
                    className="mt-4 px-6 py-2.5 bg-fazo-navy hover:bg-[#1A3E4E] text-white rounded-xl text-xs font-bold transition"
                  >
                    Close Window
                  </button>
                </div>
