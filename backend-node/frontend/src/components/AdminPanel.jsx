...
export const AdminPanel = () => {
  ...
  if (!authorized) {
    return (
      <div className="w-full flex-grow flex items-center justify-center pt-8 pb-24 px-4 bg-gradient-to-tr from-[#E6F3F5] via-[#F4F9FA] to-[#EAF2F4] min-h-[80vh]">
        ...
        <div className="absolute top-[20%] right-[10%] w-[300px] h-[300px] rounded-full bg-faazo-cyan/15 blur-[100px] pointer-events-none z-0"></div>
        <div className="absolute bottom-[20%] left-[10%] w-[300px] h-[300px] rounded-full bg-faazo-teal/15 blur-[100px] pointer-events-none z-0"></div>
        ...
        <div className="w-full max-w-md bg-white/70 backdrop-blur-2xl rounded-3xl border border-white/50 p-8 shadow-[0_20px_50px_rgba(0,108,118,0.08)] relative z-10 text-left">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-tr from-[#004d54] to-faazo-teal rounded-2xl flex items-center justify-center text-white mx-auto shadow-md mb-4">
              <Lock className="w-7 h-7" />
            </div>
            <h1 className="font-jakarta font-extrabold text-2xl text-faazo-navy tracking-tight">FAAZO System Login</h1>
            <p className="font-sans text-xs text-faazo-gray mt-1">Authenticate to access the administrator control panel.</p>
          </div>

          <form onSubmit={handleLoginSubmit} className="space-y-5">
            <div>
              <label className="block font-jakarta font-bold text-xs text-faazo-navy mb-2">USERNAME</label>
              <input 
                type="text" 
                value={username}
                onChange={e => setUsername(e.target.value)}
                placeholder="Enter admin username"
                className="w-full px-4 py-3 rounded-xl border border-faazo-border bg-white focus:outline-none focus:border-[#0A7C86] focus:ring-1 focus:ring-[#0A7C86] text-xs font-semibold text-faazo-navy"
                required
              />
            </div>

            <div>
              <label className="block font-jakarta font-bold text-xs text-faazo-navy mb-2">PASSWORD</label>
              <input 
                type="password" 
                value={password}
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-[#004d54] to-faazo-teal text-white py-3.5 rounded-xl font-jakarta font-bold text-xs transition duration-300 hover:shadow-[0_10px_20px_rgba(0,111,122,0.2)] disabled:opacity-50 flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="w-full flex-grow pb-24 relative bg-gradient-to-tr from-[#E6F3F5] via-[#F4F9FA] to-[#EAF2F4]">
      ...
      <div className="absolute top-[10%] right-[-10%] w-[350px] h-[350px] rounded-full bg-faazo-cyan/10 blur-[100px] pointer-events-none z-0"></div>
      ...
      <div className="max-w-[1350px] mx-auto px-6 lg:px-10 pt-10 relative z-10 text-left">
        ...
        {/* Header Title */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-faazo-border/70 pb-6 mb-8 gap-4">
          <div>
            <h1 className="font-jakarta font-extrabold text-3xl text-faazo-navy tracking-tight flex items-center gap-3">
        ...
        {/* Dynamic Nav tabs */}
        <div className="flex flex-wrap border-b border-faazo-border/60 mb-8 w-full gap-1">
          {[
              ...
              <button 
                ...
                className={`py-3 px-4.5 text-center font-jakarta font-bold text-xs border-b-2 flex items-center justify-center gap-2 transition ${
                  activeTab === tab.id 
                    ...
                    : 'border-transparent text-faazo-gray hover:text-faazo-navy'
                }`}
              >
          ...
          <div className="space-y-8 animate-fadeIn">
              ...
              {[
                ...
                return (
                  <div key={idx} className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-5 flex flex-col items-start shadow-sm hover:shadow-md transition">
                    ...
                    <span className="font-sans text-[11px] font-bold text-faazo-gray uppercase tracking-wider">{w.label}</span>
                    <span className="font-jakarta font-extrabold text-2xl text-faazo-navy mt-1">{w.count}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-6 bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-6 shadow-sm flex flex-col justify-between">
                <div>
                  <h3 className="font-jakarta font-bold text-base text-faazo-navy mb-4 flex items-center gap-2">
                    <FileText className="w-5 h-5 text-faazo-teal" /> Latest Job Applications
                  </h3>
                  <div className="space-y-3">
                    {(!dashboardData.recent_applications || dashboardData.recent_applications.length === 0) ? (
                      <p className="text-xs text-faazo-gray py-4">No job applications submitted yet.</p>
                    ) : (
                      (dashboardData.recent_applications || []).map(app => (
                        <div key={app.id} className="p-3 bg-white/40 border border-faazo-border/30 rounded-xl flex items-center justify-between hover:bg-white/60 transition">
                          <div>
                            <h4 className="font-jakarta font-bold text-xs text-faazo-navy">{app.full_name}</h4>
                            <span className="font-sans text-[10px] text-faazo-gray">Applied for: <span className="font-bold text-[#0A7C86]">{app.job_title}</span> • {app.applied_date}</span>
                          </div>
              ...
              <div className="lg:col-span-6 bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-6 shadow-sm flex flex-col justify-between">
                <div>
                  <h3 className="font-jakarta font-bold text-base text-faazo-navy mb-4 flex items-center gap-2">
                    <MessageSquare className="w-5 h-5 text-faazo-teal" /> Recent Contact Enquiries
                  </h3>
                  <div className="space-y-3">
                    {(!dashboardData.recent_enquiries || dashboardData.recent_enquiries.length === 0) ? (
                      <p className="text-xs text-faazo-gray py-4">No enquiries received yet.</p>
                    ) : (
                      (dashboardData.recent_enquiries || []).map(enq => (
                        <div key={enq.id} className="p-3 bg-white/40 border border-faazo-border/30 rounded-xl flex items-center justify-between hover:bg-white/60 transition">
                          <div className="max-w-[75%]">
                            <h4 className="font-jakarta font-bold text-xs text-faazo-navy">{enq.name} <span className="font-medium text-[10px] text-faazo-gray">({enq.email})</span></h4>
                            <p className="font-sans text-[11px] text-faazo-gray truncate mt-0.5">Subject: {enq.subject}</p>
                          </div>
                          {enq.contacted ? (
          ...
          <div className="animate-fadeIn">
            {isStatFormOpen ? (
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-xl shadow-sm">
                <h3 className="font-jakarta font-bold text-base text-faazo-navy border-b border-faazo-border/60 pb-3 mb-5">
                  {statForm.id ? 'Edit Statistic' : 'Add New Statistic'}
                </h3>
                <form onSubmit={handleStatSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">LABEL</label>
                      <input 
                        type="text" 
                        value={statForm.label}
                        onChange={e => setStatForm(p => ({ ...p, label: e.target.value }))}
                        placeholder="e.g. Years of Experience"
                        className="w-full px-3 py-2.5 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none focus:border-[#0A7C86]"
                        required
                      />
                    </div>
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">VALUE</label>
                      <input 
                        type="text" 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">ICON TYPE</label>
                      <select 
                        value={statForm.icon}
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">DISPLAY ORDER</label>
                      <input 
                        type="number" 
                        value={statForm.display_order}
                        onChange={e => setStatForm(p => ({ ...p, display_order: parseInt(e.target.value) || 0 }))}
                        className="w-full px-3 py-2.5 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 py-2">
                    ...
                    />
                    <label htmlFor="statActive" className="font-jakarta font-bold text-[11px] text-faazo-navy cursor-pointer">Active / Display on Home Page</label>
                  </div>

                  <div className="flex gap-3 pt-3">
                    <button type="submit" className="btn-3d-teal text-white px-5 py-2.5 rounded-lg text-xs font-bold">Save Statistic</button>
                    <button type="button" onClick={() => setIsStatFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
                  ...
                  {stats.map(stat => (
                    <div key={stat.id} className="bg-white/60 backdrop-blur-md rounded-xl border border-white/50 p-5 flex flex-col justify-between shadow-sm relative">
                      ...
                      <div>
                        ...
                        <h4 className="font-jakarta font-bold text-sm text-faazo-navy mt-1">{stat.label}</h4>
                        <span className="font-sans text-[10px] text-faazo-gray block mt-2">Icon: {stat.icon} • Order: {stat.display_order}</span>
                      </div>
                      <div className="flex gap-2.5 border-t border-faazo-border/40 pt-4 mt-5">
                        <button onClick={() => handleEditStat(stat)} className="flex-1 py-1.5 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-xs font-bold text-faazo-navy hover:text-[#0A7C86] flex items-center justify-center gap-1 transition">
            ...
            {isTestimonialFormOpen ? (
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-2xl shadow-sm">
                ...
                <form onSubmit={handleTestimonialSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CUSTOMER NAME</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">DESIGNATION</label>
                      <input 
                        type="text" 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CLINIC / COMPANY NAME</label>
                      <input 
                        type="text" 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">TESTIMONIAL CONTENT</label>
                    <textarea 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CUSTOMER IMAGE</label>
                    <div className="flex items-center gap-4">
                      {testimonialForm.image && (
                        <div className="w-12 h-12 rounded-full border border-faazo-border overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 py-2">
                    <input 
                      ...
                      className="rounded text-[#0A7C86]"
                    />
                    <label htmlFor="testimonialActive" className="font-jakarta font-bold text-[11px] text-faazo-navy cursor-pointer">Active / Display on Website</label>
                  </div>

                  <div className="flex gap-3 pt-3">
                    <button type="submit" className="btn-3d-teal text-white px-5 py-2.5 rounded-lg text-xs font-bold">Save Testimonial</button>
                    <button type="button" onClick={() => setIsTestimonialFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {testimonials.map(t => (
                    <div key={t.id} className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-6 flex flex-col justify-between shadow-sm relative">
                      ...
                      <div>
                        <p className="font-sans text-xs italic text-faazo-gray leading-relaxed">"{t.content}"</p>
                        <div className="flex items-center gap-3 mt-4">
                          ...
                          <div>
                            <h4 className="font-jakarta font-bold text-xs text-faazo-navy">{t.name}</h4>
                            <span className="font-sans text-[10px] font-semibold text-faazo-teal">{t.designation}, {t.company}</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-2.5 border-t border-faazo-border/40 pt-4 mt-5">
                        <button onClick={() => handleEditTestimonial(t)} className="flex-1 py-1.5 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-xs font-bold text-faazo-navy hover:text-[#0A7C86] flex items-center justify-center gap-1 transition">
                          <Edit className="w-3.5 h-3.5" /> Edit
                        </button>
            ...
            {isCategoryFormOpen ? (
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-2xl shadow-sm">
                ...
                <form onSubmit={handleCategorySubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CATEGORY NAME</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CUSTOM SLUG (OPTIONAL)</label>
                      <input 
                        type="text" 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">DESCRIPTION</label>
                    <textarea 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">OVERVIEW (PAGE INTRO)</label>
                    <textarea 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PRODUCT HERO IMAGE</label>
                      <div className="flex items-center gap-4">
                        {categoryForm.image && (
                          <div className="w-12 h-10 rounded border border-faazo-border overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 py-2">
                    <input 
                      ...
                      className="rounded text-[#0A7C86]"
                    />
                    <label htmlFor="categoryActive" className="font-jakarta font-bold text-[11px] text-faazo-navy cursor-pointer">Active / Show in Menu and Products Catalog</label>
                  </div>

                  <div className="flex gap-3 pt-3">
                    <button type="submit" className="btn-3d-teal text-white px-5 py-2.5 rounded-lg text-xs font-bold">Save Category</button>
                    <button type="button" onClick={() => setIsCategoryFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
                  ...
                  {categories.map(cat => (
                    <div key={cat.id} className="bg-white/60 backdrop-blur-md rounded-xl border border-white/50 p-5 flex flex-col justify-between shadow-sm relative">
                      ...
                      <div>
                        ...
                        <h3 className="font-jakarta font-bold text-base text-faazo-navy mb-1">{cat.name}</h3>
                        <p className="font-sans text-[11px] text-[#0A7C86] font-semibold mb-2">Slug: /products/{cat.slug}</p>
                        <p className="font-sans text-[12px] text-faazo-gray line-clamp-2 leading-relaxed mb-4">{cat.description}</p>
                      </div>
                      <div className="flex gap-2.5 border-t border-faazo-border/40 pt-4 mt-auto">
                        <button onClick={() => handleEditCategory(cat)} className="flex-1 py-2 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-xs font-bold text-faazo-navy hover:text-[#0A7C86] flex items-center justify-center gap-1 transition">
                          <Edit className="w-3.5 h-3.5" /> Edit
                        </button>
              ...
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-4xl shadow-sm">
                ...
                <form onSubmit={handleProductSubmit} className="space-y-5">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PRODUCT NAME</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">MAIN CATEGORY</label>
                      <select 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">SHORT DESCRIPTION</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PRODUCT DESCRIPTION</label>
                    <textarea 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="font-jakarta font-bold text-[10px] text-faazo-navy">PRODUCT FEATURES</label>
                      ...
                      {productForm.features.map((feat, idx) => (
                        <div key={idx} className="flex gap-2">
                          <input 
                            ...
                            className="flex-grow px-3 py-2 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                          />
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="font-jakarta font-bold text-[10px] text-faazo-navy">TECHNICAL SPECIFICATIONS</label>
                      ...
                      {productForm.specifications.map((spec, idx) => (
                        <div key={idx} className="flex gap-2">
                          <input 
                            ...
                            className="w-1/3 px-3 py-2 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                          />
                          <input 
                            type="text"
                            value={spec.value}
                  ...
                  <div className="grid grid-cols-2 gap-6 p-4 bg-white/40 border border-faazo-border/30 rounded-2xl">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">HERO IMAGE</label>
                      <div className="flex items-center gap-3">
                        {productForm.image && (
                          <div className="w-10 h-10 rounded border border-faazo-border overflow-hidden">
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">BROCHURE (PDF)</label>
                      <div className="flex items-center gap-3">
                        {productForm.brochureUrl && <FileText className="w-8 h-8 text-red-500 shrink-0" />}
                        <label className="cursor-pointer border border-faazo-navy text-faazo-navy hover:bg-faazo-navy/5 font-jakarta font-bold text-xs px-3.5 py-2.5 rounded-lg flex items-center gap-1.5 shadow-sm transition">
                    ...
                    <div className="col-span-2">
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PRODUCT GALLERY IMAGES (MULTIPLE)</label>
                      
                      {/* Render existing backend gallery list */}
                      {productForm.gallery_images?.length > 0 && (
                        <div className="flex flex-wrap gap-2.5 mb-3 p-3 bg-white/50 rounded-xl border border-faazo-border/20">
                          {productForm.gallery_images.map(img => (
                            <div key={img.id} className="relative w-16 h-12 rounded border border-faazo-border/60 overflow-hidden group">
                      ...
                      <div className="flex items-center gap-3">
                        {productForm.gallery?.length > 0 && <span className="text-xs font-semibold text-faazo-gray">{productForm.gallery.length} new photos selected</span>}
                        <label className="cursor-pointer border border-[#0A7C86] text-[#0A7C86] hover:bg-[#0A7C86]/5 font-jakarta font-bold text-xs px-3.5 py-2.5 rounded-lg flex items-center gap-1.5 shadow-sm transition">
                  ...
                  {/* SEO Details */}
                  <div className="p-4 bg-white/40 border border-faazo-border/30 rounded-2xl space-y-4">
                    <h4 className="font-jakarta font-bold text-xs text-faazo-navy">SEO Meta tags Override (Recommended for Rankings)</h4>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">SEO TITLE</label>
                        <input 
                          type="text" 
                          value={productForm.seoTitle || productForm.seo_title || ''}
                          onChange={e => setProductForm(p => ({ ...p, seoTitle: e.target.value }))}
                          placeholder="FAAZO Premium LED Handpiece - Low Vibration"
                          className="w-full px-3 py-2.5 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">SEO META DESCRIPTION</label>
                      <textarea 
                  ...
                  <div className="flex items-center gap-2 py-1">
                    <input 
                      ...
                      className="rounded text-[#0A7C86]"
                    />
                    <label htmlFor="prodActive" className="font-jakarta font-bold text-[11px] text-faazo-navy cursor-pointer">Active / Visible on website</label>
                  </div>

                  <div className="flex gap-3 pt-3">
                    <button type="submit" className="btn-3d-teal text-white px-5 py-2.5 rounded-lg text-xs font-bold">Save Product</button>
                    <button type="button" onClick={() => setIsProductFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
              <div>
                ...
                <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 overflow-hidden shadow-sm">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-white/40 border-b border-faazo-border/60">
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Product</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Category Link</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Features / Specs</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Status</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase text-right">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {products.map((prod) => (
                        <tr key={prod.id} className="border-b border-faazo-border/30 last:border-b-0 hover:bg-white/20 transition">
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="w-12 h-10 rounded bg-[#E1EDF0] overflow-hidden flex-shrink-0 border border-faazo-border/30">
                                <img src={getImageUrl(prod.image) || "/hero/accessories_4_3.webp"} alt="" className="w-full h-full object-cover" />
                              </div>
                              <div>
                                <h4 className="font-jakarta font-bold text-sm text-faazo-navy leading-tight">{prod.name}</h4>
                                <span className="font-sans text-[11px] text-faazo-gray font-medium">/{prod.slug}</span>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col text-[11px] text-faazo-gray">
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="inline-flex gap-2">
                              <button onClick={() => handleEditProduct(prod)} className="p-2 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-faazo-navy hover:text-[#0A7C86] transition">
            ...
            {isDealerFormOpen ? (
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-2xl shadow-sm">
                ...
                <form onSubmit={handleDealerSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">DEALER/DISTRIBUTOR NAME</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PARTNER TYPE</label>
                      <select 
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">COUNTRY</label>
                      <select 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">STATE / REGION</label>
                      <select 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CITY</label>
                      <input 
                        type="text" 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">FULL STREET ADDRESS</label>
                    <textarea 
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">CONTACT PERSON</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">PHONE NUMBER</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">EMAIL ADDRESS</label>
                      <input 
                        type="email" 
                  ...
                  <div>
                    <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">GOOGLE MAPS EMBED OR REDIRECT LINK</label>
                    <input 
                      type="url" 
                  ...
                  <div className="flex items-center gap-2 py-2">
                    <input 
                      ...
                      className="rounded text-[#0A7C86]"
                    />
                    <label htmlFor="dealerActive" className="font-jakarta font-bold text-[11px] text-faazo-navy cursor-pointer">Active Partner / Visible on Dealer page</label>
                  </div>

                  <div className="flex gap-3 pt-3">
                    <button type="submit" className="btn-3d-teal text-white px-5 py-2.5 rounded-lg text-xs font-bold">Save Dealer</button>
                    <button type="button" onClick={() => setIsDealerFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
              <div>
                ...
                <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 overflow-hidden shadow-sm">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-white/40 border-b border-faazo-border/60">
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Dealer/Distributor</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Location</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Contact details</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Status</th>
                        <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase text-right">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {dealers.map((dlr) => (
                        <tr key={dlr.id} className="border-b border-faazo-border/30 last:border-b-0 hover:bg-white/20 transition">
                          <td className="px-6 py-4">
                            <div>
                              <h4 className="font-jakarta font-bold text-sm text-faazo-navy leading-tight">{dlr.name}</h4>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col text-xs font-semibold text-faazo-navy">
                              <span>{dlr.city}, {dlr.state}</span>
                              <span className="font-normal text-[10px] text-faazo-gray uppercase tracking-wider mt-0.5">{dlr.country}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            <div className="flex flex-col text-xs font-semibold text-faazo-navy">
                              <span>{dlr.contactPerson || dlr.contact_person}</span>
                              <span className="font-normal text-[11px] text-faazo-gray">{dlr.phone} • {dlr.email}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            {dlr.active ? (
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="inline-flex gap-2">
                              <button onClick={() => handleEditDealer(dlr)} className="p-2 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-faazo-navy hover:text-[#0A7C86] transition">
                                <Edit className="w-4 h-4" />
                              </button>
            ...
            {isJobFormOpen ? (
              <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 p-6 max-w-3xl shadow-sm">
                ...
                <form onSubmit={handleJobSubmit} className="space-y-5">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">JOB TITLE</label>
                      <input 
                        type="text" 
                        value={jobForm.title}
                    ...
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">SALARY PACKAGE</label>
                      <input 
                        type="text" 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block font-jakarta font-bold text-[10px] text-faazo-navy mb-1.5">JOB STATUS</label>
                      <select 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="font-jakarta font-bold text-[10px] text-faazo-navy">DESCRIPTION PARAGRAPHS</label>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="font-jakarta font-bold text-[10px] text-faazo-navy">KEY RESPONSIBILITIES</label>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="font-jakarta font-bold text-[10px] text-faazo-navy">ELIGIBILITY REQUIREMENTS</label>
                  ...
                  <div className="flex gap-3 pt-3">
                    ...
                    <button type="button" onClick={() => setIsJobFormOpen(false)} className="px-5 py-2.5 bg-faazo-border/40 border border-faazo-border/60 hover:bg-faazo-border/60 rounded-lg text-xs font-bold text-faazo-navy">Cancel</button>
                  </div>
                </form>
              </div>
            ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {jobs.map(job => (
                    <div key={job.id} className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-6 flex flex-col justify-between shadow-sm relative">
                      ...
                      <div>
                        <h3 className="font-jakarta font-bold text-base text-faazo-navy mb-1">{job.title}</h3>
                        <span className="font-sans text-[11px] text-[#0A7C86] font-semibold">{job.salary}</span>
                        <p className="font-sans text-[12px] text-faazo-gray mt-3 line-clamp-3 leading-relaxed">
                          {job.description?.paragraphs?.[0] || 'No description paragraphs provided.'}
                        </p>
                      </div>
                      <div className="flex gap-2.5 border-t border-faazo-border/40 pt-4 mt-5">
                        <button onClick={() => handleEditJob(job)} className="flex-1 py-1.5 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-xs font-bold text-faazo-navy hover:text-[#0A7C86] flex items-center justify-center gap-1 transition">
                          <Edit className="w-3.5 h-3.5" /> Edit
                        </button>
          ...
          <div className="animate-fadeIn space-y-6">
            ...
            <div className="bg-white/50 backdrop-blur-md rounded-2xl border border-white/50 p-4 shadow-sm flex flex-col md:flex-row items-center gap-4">
              <div className="relative flex-grow w-full">
                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-faazo-gray" />
                <input 
                  type="text"
                  value={appSearchQuery}
                  onChange={e => setAppSearchQuery(e.target.value)}
                  placeholder="Search applicant name, email, or phone..."
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                />
              </div>
              <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
                <div className="flex items-center gap-1.5 w-1/2 md:w-auto">
                  <Filter className="w-4 h-4 text-faazo-gray" />
                  <select 
                    value={appJobFilter}
                    onChange={e => setAppJobFilter(e.target.value)}
                    className="px-3 py-2 rounded-xl border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                  >
                ...
                <div className="flex items-center gap-1.5 w-1/2 md:w-auto">
                  <CheckSquare className="w-4 h-4 text-faazo-gray" />
                  <select 
            ...
            <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 overflow-hidden shadow-sm">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-white/40 border-b border-faazo-border/60">
                    <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Applicant</th>
                    <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Job Position</th>
                    <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Applied Date</th>
                    <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase">Status</th>
                    <th className="px-6 py-4 font-jakarta font-bold text-xs text-faazo-navy uppercase text-right">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredApplications.map(app => (
                    <tr key={app.id} className="border-b border-faazo-border/30 last:border-b-0 hover:bg-white/20 transition cursor-pointer" onClick={() => setSelectedApplication(app)}>
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          <span className="font-jakarta font-bold text-sm text-faazo-navy">{app.full_name}</span>
                          <span className="font-sans text-[11px] text-faazo-gray">{app.email} • {app.phone}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="font-jakarta font-semibold text-xs text-faazo-navy">{app.job_title || app.appliedJob}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="font-sans text-xs text-faazo-navy">{app.applied_date || app.appliedDate}</span>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right" onClick={e => e.stopPropagation()}>
                        <div className="inline-flex gap-2">
                          <a 
                            ...
                            rel="noreferrer"
                            download
                            className="p-2 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-faazo-navy hover:text-[#0A7C86] transition"
                          >
            ...
            {selectedApplication && (
              <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
                <div className="bg-white rounded-3xl border border-faazo-border/50 max-w-xl w-full p-6 shadow-2xl relative text-left">
                  <button onClick={() => setSelectedApplication(null)} className="absolute top-4 right-4 p-1 rounded-full hover:bg-faazo-border/20 text-faazo-navy"><X className="w-5 h-5" /></button>
                  <h3 className="font-jakarta font-bold text-lg text-faazo-navy border-b border-faazo-border/40 pb-3 mb-4">Application Details</h3>
                  
                  <div className="space-y-4 font-sans text-xs">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Applicant Name</span>
                        <span className="text-sm font-bold text-faazo-navy mt-0.5 block">{selectedApplication.full_name}</span>
                      </div>
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Applied Position</span>
                        <span className="text-sm font-bold text-faazo-navy mt-0.5 block">{selectedApplication.job_title || selectedApplication.appliedJob}</span>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Email Address</span>
                        <span className="font-semibold text-faazo-navy mt-0.5 block">{selectedApplication.email}</span>
                      </div>
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Phone Number</span>
                        <span className="font-semibold text-faazo-navy mt-0.5 block">{selectedApplication.phone}</span>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Location</span>
                        <span className="font-semibold text-faazo-navy mt-0.5 block">{selectedApplication.location}</span>
                      </div>
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Submission Date</span>
                        <span className="font-semibold text-faazo-navy mt-0.5 block">{selectedApplication.applied_date || selectedApplication.appliedDate}</span>
                      </div>
                    </div>

                    {selectedApplication.cover_letter && (
                      <div>
                        <span className="block font-jakarta font-bold text-[10px] text-faazo-gray uppercase">Cover Letter / Message</span>
                        <p className="p-3 bg-faazo-border/10 rounded-xl mt-1 text-[11px] leading-relaxed max-h-32 overflow-y-auto">{selectedApplication.cover_letter}</p>
                      </div>
                    )}
                    ...
                    <div className="flex items-center gap-3 p-3 bg-[#E6F3F5] border border-[#0A7C86]/20 rounded-2xl">
                      ...
                      <div className="flex-grow">
                        ...
                        <span className="text-[11px] font-semibold text-faazo-navy">{selectedApplication.resume ? selectedApplication.resume.split('/').pop() : 'resume_file.pdf'}</span>
                      </div>
                    ...
                    <div className="pt-4 border-t border-faazo-border/40 flex items-center justify-between gap-4">
                      <div className="flex items-center gap-2">
                        <span className="font-jakarta font-bold text-xs text-faazo-navy">Update Status:</span>
                        <select 
                          value={selectedApplication.status}
                          onChange={e => handleUpdateAppStatus(selectedApplication.id, e.target.value)}
                          className="px-3 py-1.5 rounded-lg border border-faazo-border bg-white text-xs font-semibold text-faazo-navy focus:outline-none"
                        >
                          <option value="New">New</option>
                          <option value="Under Review">Under Review</option>
                          <option value="Shortlisted">Shortlisted</option>
                ...
                <div key={enq.id} className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 p-6 flex flex-col justify-between shadow-sm relative">
                  <div>
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <h4 className="font-jakarta font-bold text-base text-faazo-navy leading-snug">{enq.subject}</h4>
                        <span className="font-sans text-[11px] text-faazo-gray mt-1 block">From: <span className="font-bold text-faazo-navy">{enq.name}</span> ({enq.email})</span>
                      </div>
                      <span className="font-sans text-[10px] text-faazo-gray text-right">{new Date(enq.submitted_date || enq.submittedDate).toLocaleString()}</span>
                    </div>

                    <div className="p-4 bg-white/40 border border-faazo-border/30 rounded-xl mt-4 text-xs font-medium text-faazo-navy leading-relaxed">
                      {enq.message}
                    </div>

                    {enq.phone && <div className="mt-3 font-sans text-[11px] text-faazo-navy">Phone: <strong>{enq.phone}</strong> {enq.company && <span>• Company: <strong>{enq.company}</strong></span>}</div>}
                  </div>

                  <div className="flex gap-3 border-t border-faazo-border/40 pt-4 mt-5">
                    {enq.contacted ? (
                      <button 
                      ...
                      <button 
                        ...
                        className="flex-grow py-2 border border-faazo-border hover:bg-[#0A7C86]/5 hover:border-[#0A7C86] rounded-lg text-xs font-bold text-faazo-navy hover:text-[#0A7C86] flex items-center justify-center gap-1.5 transition"
                      >
