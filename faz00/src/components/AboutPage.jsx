  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: isHovered
          ? '0 20px 40px rgba(10, 124, 134, 0.08)'
          : '0 12px 40px rgba(10, 124, 134, 0.02)',
        background: isHovered
          ? `radial-gradient(220px circle at ${mousePos.x}px ${mousePos.y}px, rgba(10, 124, 134, 0.25) 0%, rgba(10, 124, 134, 0.05) 100%)`
      ...
      >
        ...
        {isHovered && (
          <div
            ...
            style={{
              background: `radial-gradient(250px circle at ${mousePos.x}px ${mousePos.y}px, rgba(10, 124, 134, 0.04), transparent 75%)`
            }}
          />
        )}
...
const StatsSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-12 left-12 w-24 h-24 opacity-[0.06] text-[#0A7C86] pointer-events-none hidden md:block z-0">
      ...
      <div className="absolute top-12 right-12 w-24 h-24 opacity-[0.06] text-[#0A7C86] pointer-events-none hidden md:block z-0">
        <svg width="96" height="96" fill="currentColor">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 opacity-[0.03] text-[#0A7C86] pointer-events-none z-0">
    ...
    >
      ...
      <div className="w-full lg:w-[55%] relative z-10 pl-0 pr-0">
        ...
        >
          ...
          <div
            ref={progressFillRef}
            className="absolute top-0 left-0 w-full bg-[#0A7C86] rounded-full origin-top"
          />
        </div>
          ...
          {milestones.map((milestone, idx) => {
            ...
            return (
              ...
              >
                  ...
                  >
                    <div
                      className={`rounded-full border-2 transition-all duration-500 ${isActive
                        ? 'w-5 h-5 border-[#0A7C86] bg-white shadow-[0_0_16px_rgba(10,124,134,0.6)] flex items-center justify-center'
                        : isCompleted
                          ? 'w-4 h-4 border-[#0A7C86] bg-[#0A7C86]'
                          : 'w-4 h-4 border-gray-300 bg-white'
                        }`}
                    >
                      {isActive && (
                        <div className="w-2 h-2 rounded-full bg-[#0A7C86] animate-pulse" />
                      )}
                    </div>
                  </div>
                ...
                <span className="font-jakarta font-bold text-[12px] tracking-[0.25em] text-[#0A7C86] uppercase mb-2 block">
                  MILESTONE 0{idx + 1}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div 
            ...
            style={{ 
              ...
              borderColor: 'rgba(10, 124, 134, 0.12)',
              boxShadow: '0 20px 60px rgba(10, 124, 134, 0.08)' 
            }}
          >
            {/* Soft teal gradient highlight in top-left corner */}
            <div className="absolute -top-16 -left-16 w-48 h-48 bg-[#0A7C86]/[0.08] blur-[60px] rounded-full pointer-events-none transition-all duration-500 group-hover:bg-[#0A7C86]/[0.15]" />
            
            {/* Very subtle teal tint inside the glass */}
            <div className="absolute inset-0 bg-[#0A7C86]/[0.06] pointer-events-none" />
            ...
            <div className="absolute inset-0 border border-transparent group-hover:border-[#0A7C86]/[0.25] rounded-[32px] transition-all duration-500 pointer-events-none shadow-[inset_0_0_20px_rgba(10,124,134,0)] group-hover:shadow-[inset_0_0_20px_rgba(10,124,134,0.05)]" />

            {/* Vertical accent line */}
            <div className="absolute left-0 top-12 bottom-12 w-[4px] bg-[#0A7C86] opacity-80 rounded-r-full relative z-20" />
            
            <div className="relative z-10">
              <span className="animate-card-content font-jakarta font-bold text-[11px] sm:text-[12px] tracking-[0.3em] text-[#0A7C86] uppercase mb-4 block">
                01 — OUR MISSION
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 w-full items-stretch">
          {values.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative overflow-hidden backdrop-blur-md bg-white/60 border border-[#0A7C86]/15 hover:border-[#0A7C86]/60 rounded-[16px] p-8 flex flex-col items-start shadow-[0_4px_20px_rgba(0,108,118,0.01)] hover:shadow-[0_12px_30px_rgba(0,131,143,0.08)] transition-all duration-300 ease-out transform hover:-translate-y-[5px] group"
              >
                {/* Minor teal tint overlay inside the card */}
                <div className="absolute inset-0 bg-[#0A7C86]/[0.02] pointer-events-none group-hover:bg-[#0A7C86]/[0.05] transition-colors duration-300 z-0" />
...
export const AboutPage = () => {
  return (
    <>
      <section
        id="about"
        className="relative pt-0 bg-white min-h-[calc(100vh_-_80px)] flex flex-col justify-center items-center overflow-hidden flex-grow bg-cover bg-[75%_center] md:bg-center bg-no-repeat"
        style={{
