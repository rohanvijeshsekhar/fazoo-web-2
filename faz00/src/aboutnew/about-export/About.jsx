  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-14 h-14 rounded-full flex items-center justify-center bg-fazo-light/50 border border-fazo-border/50 shadow-sm text-[#00838F] mb-6 transition-transform duration-300 group-hover:scale-110 backdrop-blur-sm z-10">
          <Icon className="w-6.5 h-6.5 stroke-[1.5]" />
        </div>
        {/* Number */}
        <div className="font-jakarta font-extrabold text-[2.75rem] sm:text-[3.25rem] text-fazo-navy leading-none mb-3 tracking-tight selection:bg-[#00838F]/10 transition-colors duration-300 group-hover:text-[#00838F] z-10">
          {count}{suffix}
        </div>
        {/* Label */}
...
const JourneySection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-white pt-24 md:pt-32 pb-16 md:pb-20 flex flex-col lg:flex-row items-stretch border-t border-fazo-border/50"
    >
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-auto right-[30px] lg:left-0 lg:right-auto top-1/2 translate-x-1/2 lg:-translate-x-1/2 -translate-y-1/2 z-30 flex items-center">
                  ...
                  <span
                    className={`absolute left-8 font-jakarta font-bold text-xs transition-colors duration-500 whitespace-nowrap hidden xl:block ${isActive ? 'text-[#00838F]' : 'text-fazo-navy/35'
                      }`}
                  >
                    {milestone.year}
                  </span>
                ...
                {/* Year display */}
                <div
                  className={`font-jakarta font-extrabold text-[80px] sm:text-[96px] lg:text-[104px] xl:text-[110px] leading-none mb-4 select-none transition-colors duration-[800ms] ${isActive ? 'text-[#00838F]' : 'text-fazo-navy/10'}`}
                >
                  {milestone.year}
                </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16 md:py-24 w-full z-10 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <a href="#" className="flex items-center justify-center gap-2 bg-fazo-teal hover:bg-[#005A64] text-white px-8 py-4 rounded-lg font-jakarta font-bold text-[15px] shadow-lg shadow-fazo-teal/15 transition-all duration-200 group w-full sm:w-auto">
              Our Story <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </a>

            <a href="#" className="flex items-center justify-center gap-2 bg-white hover:bg-fazo-light text-fazo-teal border border-fazo-teal hover:border-[#005A64] px-8 py-4 rounded-lg font-jakarta font-bold text-[15px] transition-all duration-200 w-full sm:w-auto group">
